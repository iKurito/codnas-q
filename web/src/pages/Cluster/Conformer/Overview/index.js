...
const Overview = ({ idx }) => {
  ...
  return (
    <Fragment>
      <div className="grid grid-cols-1 xl:grid-cols-5 xl:gap-4">
        <div className="mt-8 border border-gray-200 rounded-t-xl shadow-md hover:shadow-2xl col-span-3">
        ...
        <div className="col-span-2 mt-8 border border-gray-200 rounded-t-xl shadow-md hover:shadow-2xl">
          <View idx={idx} />
        </div>
      </div>
    </Fragment>
